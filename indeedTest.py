...
client = IndeedClient('3869750015307590')
streamLimit=25
...
for z in zipcodes:
    #print("zipcode "+z)
    logging.info("Fetching jobs in "+ z)
    try:
    ...
    for i in range(int(math.ceil(num_results/streamLimit))+1):
        ...
        try:
            ...
            continue
        parse_jobs(jobs)
    logging.info("Done fetching jobs in "+ z)
    logging.info("Could not retrieve "+ str(num_results-1000)+" jobs in zipcode "+ z )
